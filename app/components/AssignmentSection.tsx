...
const assignments = [
  {
    ...
    videoId: 'https://youtu.be/7FtWk9S5Ycc?si=3sKNhk4iMRHI8muE', 
    tags: ['DATA SCIENCE'],
  },
  {
    id: 2,
    ...
    videoId: 'https://youtu.be/Q0pOeEi_Uec?si=RjDD6YZL1yLoJ7Ta',
    tags: ['DATA SCIENCE'],
  },
  {
    id: 3,
    ...
    // description: 'Documenting the process of building a modern portfolio with Framer Motion and Tailwind CSS.',
    videoId: 'https://youtu.be/u3Di_JPVfVA?si=G4De7wrHfVwaK65c',
    tags:  ['DATA SCIENCE'],
  },
  {
    id: 4,
    ...
    // description: 'Documenting the process of building a modern portfolio with Framer Motion and Tailwind CSS.',
    videoId: 'https://youtu.be/EmueWK6I_y4?si=cMzGYi-sQYqn-aye',
    tags:  ['DATA SCIENCE'],
  },
  {
    id: 5,
    ...
    // description: 'Documenting the process of building a modern portfolio with Framer Motion and Tailwind CSS.',
    videoId: 'https://youtu.be/m1F9yArE6Ps?si=s83CX64mw_bbS8we',
    tags:  ['DATA SCIENCE'],
  },
  {
    id: 6,
    ...
    // description: 'Documenting the process of building a modern portfolio with Framer Motion and Tailwind CSS.',
    videoId: 'https://youtu.be/JzLmaSNK5vc?si=oVKZkzuBaw4P_F__',
    tags:  ['DATA SCIENCE'],
  },
  {
    id: 7,
    ...
    // description: 'Documenting the process of building a modern portfolio with Framer Motion and Tailwind CSS.',
    videoId: 'https://youtu.be/1isbsCP8veI?si=3evn0pvbCB2ampf-',
    tags:  ['DATA SCIENCE'],
  },
